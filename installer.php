...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20230303_epicodeprogetto0303_5a61db49ded088c31938_20230303161512_archive.zip';
        const ARCHIVE_SIZE       = '379872';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '5a61db4-03161512';
        const SECONDARY_PACKAGE_HASH = '7ec1889-03161512';
